...
- Added local Home Assistant brand assets so the integration uses the approved
  Volcano Hybrid HA × S&B icon and logo instead of the generic fallback icon.
- Added matching staging assets for a future Home Assistant brands submission.
